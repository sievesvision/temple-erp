...
<div class="container py-4">
    <div class="mb-4">
        <a href="{{ route('admin.accountants.index') }}" class="text-warning text-decoration-none fw-semibold">
            <i class="bi bi-arrow-left me-1"></i> Back to Accountants List
        </a>
    </div>
    ...
    <div class="form-card">
        <h2><i class="bi bi-person-plus text-warning me-2"></i>Add New Accountant</h2>
        ...
        <form action="{{ route('admin.accountants.store') }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="name" class="form-control rounded-3 @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="e.g. Accountant Name" required>
                    @error('name')
                ...
                <div class="col-md-6">
                    ...
                    <input type="email" name="email" class="form-control rounded-3 @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="e.g. accountant@temple.com" required>
                    @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <h4 class="mt-4 mb-2" style="font-size: 1.15rem; font-weight: 700; color: #b8863a; border-bottom: 1px solid #f0ece6; padding-bottom: 8px;">Bank Account Details (Optional)</h4>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="account_number" class="form-control rounded-3 @error('account_number') is-invalid @enderror" value="{{ old('account_number') }}" placeholder="Bank account number">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="branch_name" class="form-control rounded-3 @error('branch_name') is-invalid @enderror" value="{{ old('branch_name') }}" placeholder="Bank branch name">
                    @error('branch_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="text-end">
                <button type="submit" class="btn btn-submit text-white fw-bold">Add Accountant</button>
            </div>
        </form>
    </div>
</div>
