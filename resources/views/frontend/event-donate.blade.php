        ...
        <div class="container" style="max-width:800px;">
            ...
            <div id="donate-now" class="donate-section-anchor">
                ...
                @else
                    ...
                    @include('frontend.partials.donate-form', ['temple' => $temple, 'lockedEvent' => $event, 'donationOptions' => $donationOptions, 'formAction' => route('donate.without.login'), 'formId' => 'event-donate-form', 'stripeEnabled' => $stripeEnabled, 'requireDonorEmail' => $requireDonorEmail, 'requireDonorMobile' => $requireDonorMobile])
                @endif
            </div>
