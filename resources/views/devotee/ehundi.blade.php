...
@section('title', 'Temple e-Hundi — Sacred Online Donation')
@section('header-title', 'e-Hundi Offering')
...
@section('page-js')
  <script>
    ...
    function makeCoin(denom) {
      const labelMap = { 5: `${CURRENCY} 5`, 2: `${CURRENCY} 2`, 1: `${CURRENCY} 1`, 0.5: '50p', 0.25: '25p' };
    ...
    async function handleDonate(e) {
      ...
      const contentWidth = contentArea ? contentArea.clientWidth : window.innerWidth;
      const contentLeft = contentArea ? contentArea.getBoundingClientRect().left : 0;
      const startX = contentLeft + contentWidth * 0.5;
