  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #ebdcc5; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.03);">
    ...
    <div style="padding: 40px 30px; text-align: center;">
      ...
      <p style="color: #52473c; font-size: 16px; line-height: 1.6; margin-bottom: 30px;">
        This is to notify you that your account password has been changed successfully.
      </p>

      <div style="background-color: rgba(21, 128, 61, 0.05); border: 1px solid #bbf7d0; border-radius: 12px; padding: 15px; margin: 25px auto; max-width: 350px;">
        <span style="font-size: 15px; font-weight: 600; color: #15803d; display: block;">
          ✔ Password Updated Successfully
        </span>
      </div>

      <p style="color: #7a6e63; font-size: 14px; margin-top: 30px; text-align: left;">
        If you performed this action, no further steps are needed.
      </p>
      
      <div style="margin: 30px 0; border-top: 1px solid #f3ede2;"></div>

      <p style="color: #d01919; font-size: 13px; line-height: 1.5; margin: 0; text-align: left; font-weight: 600;">
        ⚠️ <strong>Important Security Notice:</strong> If you did not make this change, please contact the temple administrator immediately to secure your account.
      </p>
    </div>
