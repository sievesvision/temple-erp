  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e2ddd3;">
    ...
    <div style="padding: 35px 30px;">
      ...
      <p style="color: #52473c; font-size: 15px; line-height: 1.6; margin-bottom: 22px;">
        This is to confirm that your account password was changed successfully. If you made this change, no further action is needed.
      </p>

      <div style="border-top: 1px solid #e2ddd3; margin: 22px 0;"></div>

      <p style="color: #d01919; font-size: 13px; line-height: 1.6; margin: 0; font-weight: 600;">
        Important: if you did not make this change, please contact the temple administrator immediately to secure your account.
      </p>
    </div>
