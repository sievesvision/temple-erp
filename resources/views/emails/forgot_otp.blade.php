  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e2ddd3;">
    ...
    <div style="padding: 35px 30px;">
      ...
      <p style="color: #52473c; font-size: 15px; line-height: 1.6; margin-bottom: 26px;">
        You requested to reset your password. Use the verification code below to confirm your identity and continue.
      </p>
      ...
      <p style="color: #7b6b5a; font-size: 13px; line-height: 1.6; margin: 0;">
        <strong>Security notice:</strong> never share this code with anyone. Temple staff will never ask for your password or a reset code. If you did not request this, please ignore this email.
      </p>
    </div>
